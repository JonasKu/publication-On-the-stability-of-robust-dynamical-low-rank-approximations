...
mutable struct Settings
    ...
    function Settings(Nx::Int=2002,problem::String="LineSource")
        ...
        ICType = "LS"; # Possibilities are LS, shock
        ...
        # build class
        new(Nx,NCells,a,b,dx,tEnd,dt,cfl,nPN,uL,uR,x0,x1,x,xMid,problem,ICType,BCType,sigmaT,sigmaS,r,true,true,stabilization);
    end
